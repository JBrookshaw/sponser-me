...
module.exports = {
	...
	google: {
		clientID: process.env.GOOGLE_ID || '205739699727-q62gnhcuookuu9u4c49rkoelhf12tae4.apps.googleusercontent.com',
		clientSecret: process.env.GOOGLE_SECRET || 'JH1O5LKhNRx4LjndeBuh7eoQ',
